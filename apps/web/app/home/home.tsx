      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
          <div className="w-full max-w-md flex flex-col items-center">
            ...
            {/* Footer — the upstream "Powered by LearnHouse" attribution is
                intentionally not rendered on this self-branded deployment. */}
            <CopyrightFooter year={new Date().getFullYear()} className="mt-14 pt-0" />
          </div>
        </div>
      </div>
    </div>
